...
var LuaHighlightRules = function() {
    ...
    var builtinConstants = ("true|false|nil|_G|_VERSION|game|is_visage_closure|is_executor_closure");
    ...
    var functions = (
        ...
        "pairs|rawget|loadstring()|loadstring()()|ipairs|_VERSION|dofile|setfenv|"+
        "load|error|loadfile|"+        
        "game:HttpGet()|game:HttpGetAsync()|loadstring(game:HttpGet())()|loadstring(game:HttpGetAsync())()|"+
        "gethiddenproperty(path, property)|sethiddenproperty(path, property, value)|setfflag(fflag, value)"+

        "task|wait()|task.wait()|game:GetService(\"service_name\")|"+
        "sub|upper|len|gfind|rep|find|match|char|dump|gmatch|"+
        "reverse|byte|format|gsub|lower|preload|loadlib|loaded|"+
        "loaders|cpath|config|path|seeall|exit|setlocale|date|"+
        "getenv|getgenv|getrenv|getsenv|difftime|remove|time|clock|tmpname|rename|execute|"+
        ...
        "status|wrap|create|running|wait|"+
